            ...
            vpgrid id "ext":
                ...
                frame:
                    ...
                    vbox:
                        ...
                        imagebutton:
                            idle LiveComposite((150, 130), (50, 20), "mod_assets/mod_extra_images/about.png", (45, 75), Text("Info", style="extras_text"))
                            hover LiveComposite((150, 130), (50, 20), "mod_assets/mod_extra_images/about.png", (43, 73), Text("Info", style="extras_hover_text"))
                            action ShowMenu("modInfo")
