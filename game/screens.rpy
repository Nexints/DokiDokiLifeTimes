    ...
    use game_menu(_("Credits"), scroll="viewport"):
        ...
        window:
            ...
            vbox:
                ...
                text "Check the credits.txt file for additional credits that can't fit here!"


## Mod Info screen ################################################################
##
## Just a mod info screen.
##
## This displays info about DDLT.
...
screen modInfo():
    ...
    ## vbox child is then included inside the viewport inside the game_menu
    ## screen.
    use game_menu(_("modInfo"), scroll="viewport"):
